...
class Part2Test {
    ...
    void small() throws FileNotFoundException {
        assertEquals(123, handleInput("test/data/problem5/small_input.txt"));
    }

    @Test
    void big() throws FileNotFoundException {
        assertEquals(4507, handleInput("test/data/problem5/big_input.txt"));
    }
